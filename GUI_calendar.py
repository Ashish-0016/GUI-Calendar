...
def pick_date(event):
    ...
    submit_btn = Button(date_window, text="Submit", command=lambda: grab_date(cal), bg="#003366", fg="white", font=("Helvetica", 12, "bold"))
    submit_btn.place(x=110, y=215)
...
date_label = Label(root, text="Date Chosen:", bg="#003366", fg="white", font=("Helvetica", 14, "bold"))
date_label.place(x=160, y=60)
